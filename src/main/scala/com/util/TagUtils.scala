...
object TagUtils {
  ...
  def getOneUserId(row:Row):String={
    row match {
      ...
      case t if StringUtils.isNotBlank(t.getAs[String]("macmd5")) => "MAC"+t.getAs[String]("macmd5")
      ...
      case t if StringUtils.isNotBlank(t.getAs[String]("macsha1")) => "MAC"+t.getAs[String]("macsha1")
